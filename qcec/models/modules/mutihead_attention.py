...
class MultiheadAttention(nn.Module):
    ...
    def forward(self, query, key, value, key_padding_mask=None, incremental_state=None,
        ...
        try:
            ...
            # Fairseq provides the historical implementation, but using the
            # native operation keeps the copied QCEC project usable for
            # lightweight CPU smoke tests when fairseq is not installed.
            attn_weights = torch.softmax(attn_weights, dim=-1).type_as(
                attn_weights)
