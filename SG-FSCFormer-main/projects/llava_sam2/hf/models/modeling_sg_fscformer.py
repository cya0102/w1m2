...
from .configuration_sg_fscformer import SGFSCFormerConfig
...
class SGFSCFormerModel(PreTrainedModel):
    config_class = SGFSCFormerConfig
    ...
    def __init__(self, config: SGFSCFormerConfig, vision_model=None, language_model=None, use_flash_attn=True):
